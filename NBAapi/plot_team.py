...
def court(ax=None, color='black', lw=4, outer_lines=False,direction='up',short_three=False):
    ...
    if ax is None:
        if direction=='up':
            ...
            plt.text(22,44,'By: SQ',color='black',horizontalalignment='center',fontsize=20,fontweight='bold')
        elif direction=='down':
            ax = plt.gca(xlim = [30,-30],ylim = [-7,43],xticks=[],yticks=[],aspect=1.0)
            plt.text(-22,-7,'By: SQ',color='black',horizontalalignment='center',fontsize=20,fontweight='bold')
        else:
            ax = plt.gca()
...
def shot_heatmap(df,sigma = 1,log=False,player_pic=True,ax=None,cmap='jet'):
    ...
    ax.text(0,-7,'By: SQ',color='white',horizontalalignment='center',fontsize=20,fontweight='bold')
...
def shot_scatter(df,player_pic=True,ax=None,noise=True,**kwargs):
    ...
    ax.text(0,-7,'By: SQ',color='black',horizontalalignment='center',fontsize=20,fontweight='bold')
